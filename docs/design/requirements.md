...
| 项目名称 | 献血管理系统 |
| 文档类型 | 技术设计文档 |
| 技术范围 | Java Swing + JDBC + MySQL + MongoDB |
| 适用阶段 | 需求分析、设计、开发、测试、答辩 |
| 文档日期 | 2026-07-06 |

## 1. 项目概述

献血管理系统用于支持血站对献血者、血液库存、用血申请、操作日志和统计报表进行统一管理。系统通过 MySQL 保存用户、分类、库存批次、用血申请和实名档案等结构化数据，通过 MongoDB 保存行为日志、评论、库存详情和系统日志等扩展数据。
